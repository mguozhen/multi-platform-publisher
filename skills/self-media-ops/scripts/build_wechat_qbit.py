...
TAIL = (DIVIDER +
  ...
  '<strong>一键三连</strong><span style="color: {g};"><strong>「点赞」「转发」「小心心」</strong></span></p>'
  ...
  '<span style="color: {g};"><strong>关注「Agent101」，每天一篇硅谷前沿 AI 观察</strong></span></p>').replace('{g}', GREEN)
